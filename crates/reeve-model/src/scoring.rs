...
// produce EvaluationComplete events the renderer displays but do not
// factor into this score. They signal anomalies rather than quality
// degradation, which the health score is designed to measure.
